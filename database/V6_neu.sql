...
CREATE TABLE IF NOT EXISTS `devices` (
  ...
  CONSTRAINT `user_constraint` FOREIGN KEY (`device_lend_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Exportiere Daten aus Tabelle ausleihe_v6.prebook: ~2 rows (ungefähr)
INSERT INTO `prebook` (`prebook_id`, `prebook_user_id`, `prebook_amount`, `prebook_begin`, `prebook_end`) VALUES
	(1, 1, 30, '2023-08-15 08:00:00', '2023-08-15 08:30:00'),
	(2, 25, 10, '2023-08-08 17:23:57', '2023-08-08 17:33:57');
...
-- Exportiere Daten aus Tabelle ausleihe_v6.property_token_permissions: ~12 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle ausleihe_v6.token: ~3 rows (ungefähr)
INSERT INTO `token` (`token_id`, `token_username`, `token_password`, `token_last_change`) VALUES
	...
	(2, 'admin', '$2y$10$hz/0PVCe984eTLiDt1CVQuujonwqA9Y0gUu4hvMp5pQNLPb3gVnfa', '2023-07-07 09:34:49'),
	(5, 'abc', '$2y$10$iOjmvLDcaQDteU7G6uAYOOaJtPB3uDvO6RmRMz3GMSVuedsmECdL2', '2023-08-08 14:01:35');
...
-- Exportiere Daten aus Tabelle ausleihe_v6.token_link_permissions: ~24 rows (ungefähr)
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `user_token_constraint` (`user_token_id`),
  ...
  CONSTRAINT `user_token_constraint` FOREIGN KEY (`user_token_id`) REFERENCES `token` (`token_id`) ON UPDATE CASCADE,
...
INSERT INTO `user` (`user_id`, `user_firstname`, `user_lastname`, `user_class`, `user_token_id`, `user_usercard_id`) VALUES
	...
	(69, 'Ruben', 'Eversmeier', 1, NULL, 131),
	(71, 'Admin', 'Admin', 1, 2, NULL);
